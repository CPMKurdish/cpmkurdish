# Copyright (c) 2025 Rick Dev Solutions
# All rights reserved.
# This code is the intellectual property of Rick Dev Solutions and cannot be reproduced, distributed, or modified without prior permission.

# Autor / Author: Rick
# Data / Date: Janeiro 2025 / January 2025

# Licença / License:
# This code is provided "as is," without warranties of any kind, either express or implied, including but not limited to warranties of merchantability or fitness for a particular purpose.
# The use of this code is at your own risk. Rick Dev Solutions is not responsible for any direct or indirect damages, including but not limited to damages resulting from code failures.

# Uso permitido / Allowed usage:
# - Study and learning
# - Personal modifications, as long as not distributed
# - Distribution or commercial use requires prior written permission.

# Todos os direitos reservados, incluindo o direito de modificar, distribuir ou licenciar este código.
# All rights reserved, including the right to modify, distribute, or license this code.
